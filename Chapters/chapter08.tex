...
\item{} If the above step fails, check the \sensor{'indexer raw position'} sensor in sensor list for that receptor (e.g L band $=$ 40\unit{deg})
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item[$\circ$] You will also notice no ingest data on the signal display.   Type \option{flagcount} to display the figure below.
